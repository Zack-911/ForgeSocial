...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        ...
        {
            name: 'limit',
            description: 'Maximum number of playlists to return (default 5, max 25)',
            required: false,
            rest: false,
    ...
    async execute(ctx, [query, limit, uploadDate, duration, sortBy, ...features]) {
        ...
        if (!playlists) {
            return this.customError('Unable to find any playlists using the query. Try removing some filters');
        }
        const sliced = Array.isArray(playlists) ? playlists.slice(0, lim) : playlists;
        return this.success(JSON.stringify(sliced, undefined, 2));
    },
});
//# sourceMappingURL=searchYoutubePlaylist.js.map