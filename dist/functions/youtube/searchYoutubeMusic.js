...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [query, limit]) {
        ...
        if (!ext.youtube?.music)
            return this.customError('YouTube Music is not available');
        let search;
        try {
            search = await ext.youtube.music.search(q, { type: 'song' });
        }
        catch (e) {
            return this.customError('YouTube Music search failed: ' + (e instanceof Error ? e.message : String(e)));
        }
...
//# sourceMappingURL=searchYoutubeMusic.js.map