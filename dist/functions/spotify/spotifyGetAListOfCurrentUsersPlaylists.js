...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [limit, offset]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/me/playlists${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetAListOfCurrentUsersPlaylists.js.map