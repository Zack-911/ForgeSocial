...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetAudiobookChapters',
    version: '1.0.0',
    ...
    async execute(ctx, [id, market, limit, offset]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/audiobooks/${id}/chapters${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetAudiobookChapters.js.map