...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [id, market, limit, offset]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/albums/${id}/tracks${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetAnAlbumsTracks.js.map