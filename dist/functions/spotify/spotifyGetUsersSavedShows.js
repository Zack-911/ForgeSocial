...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetUsersSavedShows',
    version: '1.0.0',
    ...
    async execute(ctx, [limit, offset]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/me/shows${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetUsersSavedShows.js.map