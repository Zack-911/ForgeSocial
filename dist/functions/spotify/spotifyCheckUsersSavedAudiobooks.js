...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [ids]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/me/audiobooks/contains${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyCheckUsersSavedAudiobooks.js.map