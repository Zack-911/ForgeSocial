...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetACategoriesPlaylists',
    version: '1.0.0',
    ...
    async execute(ctx, [categoryId, limit, offset]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/browse/categories/${categoryId}/playlists${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetACategoriesPlaylists.js.map