...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [id, market]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/artists/${id}/top-tracks${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetAnArtistsTopTracks.js.map