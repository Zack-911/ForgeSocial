...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyCheckUsersSavedShows',
    version: '1.0.0',
    ...
    async execute(ctx, [ids]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/me/shows/contains${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyCheckUsersSavedShows.js.map