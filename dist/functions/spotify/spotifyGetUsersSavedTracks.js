...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetUsersSavedTracks',
    version: '1.0.0',
    ...
    async execute(ctx, [market, limit, offset]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/me/tracks${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetUsersSavedTracks.js.map