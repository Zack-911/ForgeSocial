...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetSeveralChapters',
    version: '1.0.0',
    description: 'Get Several Chapters',
    args: [
        {
            name: 'ids',
            description: 'A comma-separated list of the Spotify IDs. For example: `ids=0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU`. Maximum: 50 IDs.',
    ...
    async execute(ctx, [ids, market]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/chapters${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetSeveralChapters.js.map