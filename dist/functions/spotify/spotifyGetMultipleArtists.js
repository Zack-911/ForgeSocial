...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetMultipleArtists',
    version: '1.0.0',
    ...
    async execute(ctx, [ids]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/artists${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetMultipleArtists.js.map