...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetAnArtistsRelatedArtists',
    version: '1.0.0',
    ...
    async execute(ctx, [id]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/artists/${id}/related-artists`, token, 'GET');
...
//# sourceMappingURL=spotifyGetAnArtistsRelatedArtists.js.map