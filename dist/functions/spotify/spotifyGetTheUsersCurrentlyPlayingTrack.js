...
exports.default = new forgescript_1.NativeFunction({
    name: '$spotifyGetTheUsersCurrentlyPlayingTrack',
    version: '1.0.0',
    ...
    async execute(ctx, [market, additionalTypes]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/me/player/currently-playing${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetTheUsersCurrentlyPlayingTrack.js.map