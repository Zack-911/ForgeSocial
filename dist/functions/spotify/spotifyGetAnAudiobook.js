...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [id, market]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/audiobooks/${id}${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetAnAudiobook.js.map