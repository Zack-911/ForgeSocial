...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx, [playlistId, market, fields, limit, offset, additionalTypes]) {
        ...
        try {
            const json = await (0, spotifyFetch_1.spotifyFetch)(`/playlists/${playlistId}/tracks${queryString ? '?' + queryString : ''}`, token, 'GET');
...
//# sourceMappingURL=spotifyGetPlaylistsTracks.js.map