...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        ...
        {
            name: 'milestone',
            description: 'Milestone number, or * for issues with any milestone, or none for issues without milestones',
            required: false,
            rest: false,
            type: forgescript_1.ArgType.String,
        },
    ...
    async execute(ctx, [owner, repo, milestone, state, assignee, creator, mentioned, labels, sort, direction, since]) {
